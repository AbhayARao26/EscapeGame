...
public class Board : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        wordleManager = Object.FindAnyObjectByType<WordleManager>();
        if (wordleManager == null)
        {
            Debug.LogError("WordleManager not found in the scene! Please add it.");
        }
    }
    ...
    private void SubmitRow(Row row)
    {
        ...
        if (HasWon(row)) {
            ...
            if (wordleManager != null)
            {
                wordleManager.OnGameCompleted(true);
            }
            return;
        }
        ...
        if (rowIndex >= rows.Length) {
            ...
            if (wordleManager != null)
            {
                wordleManager.OnGameCompleted(false);
            }
        }
    }
